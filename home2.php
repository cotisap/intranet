...
if ($_SESSION["admin"] != 'Y') {
	$queryTotSales .= " AND T2.SlpCode = '".$_SESSION["salesPrson"]."'";
}
...
(SELECT SUM(T8.LineTotal) AS TOTAL
...
if ($_SESSION["admin"] != 'Y') {
	$queryTotSales .= " AND T8.SlpCode = '".$_SESSION["salesPrson"]."'";
}
...
<div id="pageContainer">
    <div id="leftCol">
				...
				*/
            	...
            	<div id="jssor_1" style="position:relative; margin:0 auto; top:0px; left:0px; width:960px; height:560px; overflow:hidden; visibility:hidden;">
                    ...
                    <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 960px; height: 560px; overflow: hidden;">
                    	<?php
						$querySlide = "SELECT title, link, file FROM SLDR WHERE company = '".$_SESSION["company"]."' AND active = 'Y'";
						$resultSlide = mysql_query($querySlide);
						while ($rowSlide = mysql_fetch_array($resultSlide)) {
							echo "<div data-p='225.00' style='display: none;'>";
							if(substr($rowSlide["link"], 0, 24) == "https://www.youtube.com/") {
								echo "<iframe width='960' height='560' src='".$rowSlide["link"]."' frameborder='0' allowfullscreen></iframe>";
							} else {
        ...
        <table class="formTable">
        	<tr>
        		<td colspan="2"><strong>Buscador Rápido de Art&iacute;culos</strong>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="itemPrice" colspan="2">$<span class="listPrice">0.00</span> <span class="currency">-</span>
				</td>
			</tr>
			<tr>
				<td>Existencia <span class="onHand">-</span>
				</td>
				<td>Pedido <span class="onOrder">-</span>
				</td>
			</tr>
		</table>
		</div>
    ...
    <div id="rightCol">
        <div class="module" id="countdown">
        	<div class="cTop">Faltan</div>
            <div class="cDays"><?php echo date('t') - date('j'); ?></div>
            <div class="cFoot">d&iacute;as<br>para cierre de mes</div>
        </div>
    </div>
</div>
