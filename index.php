...
body {
	background:#FFF url(images/fondo.jpg) no-repeat right center;
...
<div id="content">
	<?php
		//echo intval(date('H'))-6;
	?>
	<img src="images/logo-intranet.png" class="iniLogo">
    ...
    <div id="form">
        ...
        <div>
            ...
            <select id="company" name="company" required>
                ...
                <option value="manufacturing">FG Manufacturing</option>
                <option value="alianzati">Alianza TI</option>
                <option value="mbr">Nueva Sociedad</option>
            </select>
        </div>
        <div>
            <label for="email">
