...
<p class="pageTitle">Capacitación</p>

<div class="docsWrapper">
	<ul>
    <?php
	$query = "SELECT T1.id, T1.title, T1.file, T1.remarks, T2.category FROM TRNG T1 INNER JOIN TCAT T2 ON T1.category = T2.id WHERE T1.active = 'Y'";
