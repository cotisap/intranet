...
{	
	if ($this->page == 1) {
		...
		} elseif ($company == "alianza" || $company == "pacifico") {
			$this->Image("images/logo-alianza.png",10,10,70);
		} elseif ($company == "sureste") {
			$this->Image("images/logo-alianza-sureste.png",10,10,50);
		} elseif ($company == "alianzati") {
			$this->Image("images/logo-alianzati.png",10,10,40);
		}
	    // Arial bold 20
	    ...
	    //$this->Cell(190,1,' ',0,1);
		//$this->Cell(110);
		if ($company == "alianza" || $company == "pacifico" || $company == "sureste") {

		$this->SetFont('Narrow','B',8);
		$this->Cell(178.5,0);
		$this->Cell(32.66,3,'FO-VTA-02 R0',0,1,'L');
		...
		$this->Cell(32.66,5,'Tipo de cambio',0,1,'L');
